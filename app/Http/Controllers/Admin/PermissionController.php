...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backends.setting.permission.index',['permissions'=>$permission]);
    }
    ...
    {
        return view('backends.setting.permission.new');
    }
    ...
    {
       return view('backends.setting.permission.edit',['permission' => $permission]);
    }
